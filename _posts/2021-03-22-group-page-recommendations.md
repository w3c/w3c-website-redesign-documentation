...
Therefore we compromised with W3C and agreed we would do a content review, and then design any additional components needed to make improvements to the pages, that would not be already in the design system we are building. Here are our recommendations. 

## Identified usability problems and proposed solutions in general

### Understanding what groups do and how they are organised
...
### Hard to find out what is happening in my group
...
### Make it easier to find out when events are happening

**Problem:**

* How can I see a list of events for a group? * How can I subscribe to updates? * How can I see upcoming events across multiple groups?  
...
## Proposed solutions for specific pages
...
* Data should be polled and stored in a single location to make this easy to query. Suggested data to store:
   ...
   * Type (e.g. charter)
   * Group ID
* This feature may not be feasible to develop for launch, so is considered future work
...
#### Group detail - Tools
Example: https://www.w3.org/groups/wg/css/tools
...
* See data example: https://www.w3.org/PM/Groups/repositories.html?gid=32061 
